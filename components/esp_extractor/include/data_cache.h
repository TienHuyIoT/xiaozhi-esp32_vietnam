 ...
 *               - Others: Fail to open
 */
int data_cache_open(data_cache_t *chache);
 ...
 *
 * @return       - Bigger than 0: Actual size readed
...
/**
 * @brief        Read little endian interger value from data cache
 *
 * @param        cache: Data cache instance
 * @param        data: Interger value to read
 * @param        size: Size to read
 *
 * @return       - 0: On success
 *               - Others: Fail to read
...
/**
 * @brief        Read big endian interger value from data cache
 *
 * @param        cache: Data cache instance
 * @param        data: Interger value to read
 * @param        size: Size to read
