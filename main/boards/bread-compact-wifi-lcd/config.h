...
#define SONIC_SERVER_BUTTON_GPIO GPIO_NUM_1
#define DEFAULT_SERVER_BUTTON_GPIO GPIO_NUM_38
#define SERVER_SWITCH_LONG_PRESS_MS 1500
...
// Use same SPI bus as LCD for touch controller, comment out to use different
// SPI bus #define CONFIG_XPT2046_ENABLE_SAME_BUS_AS_LCD
