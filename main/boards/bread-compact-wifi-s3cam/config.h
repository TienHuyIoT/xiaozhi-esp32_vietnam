...
#define CARD_SPI_MISO_GPIO GPIO_NUM_3
#define CARD_SPI_SCLK_GPIO GPIO_NUM_48
...
#warning                                                                       \
    "MEDIA_SERVER_BASE_URL is using the default LAN address. Define it explicitly for production builds."
#endif
