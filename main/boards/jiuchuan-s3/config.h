...
#define CARD_SDMMC_CMD_GPIO GPIO_NUM_48  // MISO pin
#define CARD_SDMMC_D0_GPIO  GPIO_NUM_21  // MOSI pin
#define CARD_SDMMC_D1_GPIO  GPIO_NUM_NC
#define CARD_SDMMC_D2_GPIO  GPIO_NUM_NC
#define CARD_SDMMC_D3_GPIO  GPIO_NUM_NC  // CS pin
#else
#define CARD_SDMMC_CLK_GPIO GPIO_NUM_3
#define CARD_SDMMC_CMD_GPIO GPIO_NUM_1
#define CARD_SDMMC_D0_GPIO  GPIO_NUM_2
#endif
